...
reward = 0
params_dic = {
    "k_vertical_thrust": k_vertical_thrust,
    "k_vertical_offset": k_vertical_offset,
    "k_vertical_p": k_vertical_p,
    "k_roll_p": k_roll_p,
    "k_pitch_p": k_pitch_p,
}
...
while supervisor.step(timestep) != -1:
    ...
    emitter.send(message)
    err_x, err_y, err_z = (
        target_x - uav.getPosition()[0],
        target_y - uav.getPosition()[2],
        target_z - uav.getPosition()[1],
    )
